...
defined('SOURCE_PROJECT')		OR define('SOURCE_PROJECT', '3');
defined('SOURCE_STORE')			OR define('SOURCE_STORE', '4');
defined('SOURCE_PRODUCT')		OR define('SOURCE_PRODUCT', '5');
defined('SOURCE_FACTORY')		OR define('SOURCE_FACTORY', '6');
