...
$(window).scroll(function () {
  ...
  addbtnstyle($('.navbtnFTop'),$('.navbtnF'));
  addbtnstyle($('.navbtnGTop'),$('.navbtnG'));
});
...
$(document).on("click", ".navbtnF", function(){
  // $(window).unbind('scroll');
		$('html,body').animate({
			scrollTop: $(".navbtnFTop").offset().top},'slow'),
      $(this).addClass('arrive').siblings().removeClass('arrive');
});
$(document).on("click", ".navbtnG", function(){
  // $(window).unbind('scroll');
		$('html,body').animate({
			scrollTop: $(".navbtnGTop").offset().top},'slow'),
      $(this).addClass('arrive').siblings().removeClass('arrive');
});
...
$(document).on("click", ".jumpF", function(){
		$('html,body').animate({
			scrollTop: $(".jumpF-get").offset().top},'slow')
});
$(document).on("click", ".jumpG", function(){
		$('html,body').animate({
			scrollTop: $(".jumpG-get").offset().top},'slow')
});
