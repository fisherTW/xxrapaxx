...
// prod pay2go
/*
defined('PAY2GO_MERCHANTID')        OR define('PAY2GO_MERCHANTID', '31007503');
defined('PAY2GO_HASHKEY')           OR define('PAY2GO_HASHKEY', 'A14ymIBlbSrJ2XxVwT8VJnoh8FmAgrTR');
defined('PAY2GO_HASHIV')            OR define('PAY2GO_HASHIV', 'sXpPG1aSTBBWz9R5');
defined('PAY2GO_URL')               OR define('PAY2GO_URL', 'https://inv.pay2go.com/API/invoice_issue');
*/

// test pay2go
defined('PAY2GO_MERCHANTID')		OR define('PAY2GO_MERCHANTID', '3629824');
defined('PAY2GO_HASHKEY')			OR define('PAY2GO_HASHKEY', 'b6ZcBWS7OHh0n4pjLUjFVI4lPVnAkYbO');
defined('PAY2GO_HASHIV')			OR define('PAY2GO_HASHIV', 'kV9YmY4HAdnAfMAY');
defined('PAY2GO_URL')				OR define('PAY2GO_URL', 'https://cinv.pay2go.com/API/invoice_issue');
...
// currency
defined('PRODUCT_CURRENCY_TW') OR define('PRODUCT_CURRENCY_TW', '1');

define('JSON_CURRENCY',json_encode(array(
    PRODUCT_CURRENCY_TW     => '台幣'
)));

defined('SEND_STATUS_NOT_SEND')		OR define('SEND_STATUS_NOT_SEND', '0');
defined('SEND_STATUS_SEND')			OR define('SEND_STATUS_SEND', '1');
defined('SEND_STATUS_RETURNING')	OR define('SEND_STATUS_RETURNING', '2');
defined('SEND_STATUS_RETURNED')		OR define('SEND_STATUS_RETURNED', '3');

define('JSON_SEND_STATUS',json_encode(array(
    SEND_STATUS_NOT_SEND	=> '未出貨',
    SEND_STATUS_SEND		=> '已出貨',
    SEND_STATUS_RETURNING	=> '退貨中',
    SEND_STATUS_RETURNED	=> '已退貨'
)));