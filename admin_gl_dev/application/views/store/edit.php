...
<?php if ($id != '0'): ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<div class="input-group">			
				<input type="text" class="form-control" name="txt_user_name" value="<?= $info[0]['user_mail']?>" disabled />
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<img src="<?= isset($info[0]['pic_logo'])? URL_GOOGLE_IMG.$info[0]['pic_logo'] : URL_GOOGLE_IMG.'new-qgoods/200x200.jpg' ?>">
